...
pyinstaller --clean -y --name="Studio0808_VoxCPM" --noconsole --icon="app.ico" --add-data="assets;assets" --add-data="app.ico;." --collect-all="customtkinter" --collect-all="PIL" --collect-all="soundfile" --collect-all="sounddevice" --collect-all="torchaudio" --hidden-import="voxcpm" --hidden-import="modelscope" --hidden-import="huggingface_hub" Studio0808_VoxCPM.py
